...
const faqs = [
  {
    q: '아르코이는 어떤 앱인가요?',
    a: '고양이 코코, 비비, 애쉬가 등장하는 <br />귀여운 타로카드와 함께 마스터 루나가 다정하게 리딩하는 마음 돌봄 앱입니다.<br />현재 앱인토스의 미니앱 [ <b style="color:#ffffff">아르코이: 타로 일기</b> ]로 출시되어 있으며, 2026년 10월에 정식 출시될 예정입니다.',
  },
  {
    q: '타로를 몰라도 사용할 수 있나요?',
  ...
  {
    q: '타로 해설을 소장할 수 있나요?',
    a: '네. <br />[ <b style="color:#ffffff">해설 공유하기</b> ] 버튼을 사용하면 <br />오늘의 일기와 해설을 타로카드 배경으로 개인 소장할 수 있습니다.',
  },
  {
    q: '어디서 사용할 수 있나요?',
    a: '현재 앱인토스 미니앱에서 [ <b style="color:#ffffff">아르코이: 타로 일기</b> ]를 검색하면 설치와 회원가입 없이 바로 사용할 수 있어요. <br />미니앱에서 타로 마스터 루나를 먼저 경험해 볼 수 있으며, <br />2026년 10월. 각 스토어에 정식 출시 예정입니다.',
  },
]
