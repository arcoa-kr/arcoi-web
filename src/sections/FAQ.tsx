...
const faqs = [
  {
    q: '아르코이는 어떤 앱인가요?',
    a: '타로 마스터 루나가 당신의 하루를 다정하게 해설해 주는 셀프케어 타로앱입니다.<br />타로 마스터 오라클이 키우는 고양이(코코, 비비, 애쉬)로 그려진 오리지널 타로카드도 함께 사용해 볼 수 있습니다. <br />현재 앱인토스의 미니앱 [ <b style="color:#ffffff">아르코이: 오늘의 타로</b> ]로 미리 만날 수 있으며, 2026년 연말에 정식 출시될 예정입니다.',
  },
  {
    q: '타로를 몰라도 사용할 수 있나요?',
  ...
  {
    q: '일기는 안전한가요?',
    a: '네. <br />일기는 매일 24시에 초기화되어 민감한 정보가 전혀 남지 않습니다. 걱정 없이 솔직하게 쓸 수 있어요. <br />[ <b style="color:#ffffff">해설 간직하기</b> ] 버튼으로 오늘의 일기와 해설을 예쁘게 간직해 보세요.',
  },
  {
    q: '타로 해설을 소장할 수 있나요?',
    a: '네. <br />[ <b style="color:#ffffff">해설 간직하기</b> ] 버튼을 사용하면<br />오늘의 일기와 해설을 예쁜 타로카드 배경과 함께 간직하거나 공유할 수 있습니다.',
  },
  {
    q: '어디서 사용하나요?',
    a: '현재 토스 앱에서 [ <b style="color:#ffffff">아르코이: 오늘의 타로</b> ]를 검색하면, <b style="color:#ffffff">설치와 회원가입 없이</b> 바로 사용할 수 있어요. <br />미니앱을 통해 마스터 루나를 먼저 경험해 볼 수 있으며, <br />루나를 포함한 5명의 마스터를 모두 만날 수 있는 앱은 2026년 연말에 정식 출시 예정입니다.',
  },
]
