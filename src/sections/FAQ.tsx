...
const faqs = [
  ...
  {
    q: '어디서 사용하나요?',
    a: '현재 앱인토스 미니앱에서 [ <b style="color:#ffffff">아르코이: 타로 일기</b> ]를 검색하면, <b style="color:#ffffff">설치와 회원가입 없이</b> 바로 사용할 수 있어요. <br />미니앱을 통해 마스터 루나를 먼저 경험해 볼 수 있으며, <br />루나를 포함한 5명의 마스터를 모두 만날 수 있는 앱은 2026년 10월에 정식 출시 예정입니다.',
  },
]
