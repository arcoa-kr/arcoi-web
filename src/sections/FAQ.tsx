...
const faqs = [
  ...
  },
  {
    ...
    a: '네. <br />본인의 실물 카드로 직접 리딩할 수 있으며, 명상 타이머도 사용할 수 있습니다. <br />타로 번호를 입력하면 마스터 루나가 다정하게 해설을 해 줍니다.',
  },
  {
    q: '일기는 안전한가요?',
  ...
  {
    q: '어디에서 사용해 볼 수 있나요?',
    a: '현재 앱인토스 미니앱에서 [ <b style="color:#ffffff">아르코이: 타로 일기</b> ]를 검색하면, 설치와 회원가입 없이 바로 사용할 수 있어요. <br />미니앱을 통해 타로 마스터 루나를 먼저 경험해 볼 수 있으며, <br />루나를 포함한 5명의 마스터를 모두 만날 수 있는 앱은 2026년 10월에 정식 출시 예정입니다.',
  },
]
