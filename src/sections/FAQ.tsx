...
const faqs = [
  {
    q: '아르코이는 어떤 앱인가요?',
    a: '마스터 오라클이 키우는 고양이 코코, 비비, 애쉬가 활약하는 오리지널 타로카드를 사용하여, 마스터 루나가 당신의 하루를 다정하게 해설해 주는 마음 돌봄 앱입니다.<br />현재 앱인토스의 미니앱 [ <b style="color:#ffffff">아르코이: 오늘의 타로</b> ]로 미리 만날 수 있으며, 2026년 가을에 정식 출시될 예정입니다.',
  },
  {
    q: '타로를 몰라도 사용할 수 있나요?',
  ...
  {
    q: '어디서 사용하나요?',
    a: '현재 앱인토스 미니앱에서 [ <b style="color:#ffffff">아르코이: 오늘의 타로</b> ]를 검색하면, <b style="color:#ffffff">설치와 회원가입 없이</b> 바로 사용할 수 있어요. <br />미니앱을 통해 마스터 루나를 먼저 경험해 볼 수 있으며, <br />루나를 포함한 5명의 마스터를 모두 만날 수 있는 앱은 2026년 가을에 정식 출시 예정입니다.',
  },
]
